...
def test_stats_smoke_test(_test_book, spanish):
    ...
    assert_stats(
        [
            '4; 4; 2; 50; {"0": 50.0, "1": 50.0, "2": 0.0, "3": 0.0, "4": 0.0, "5": 0.0, "98": 0.0, "99": 0.0}'
        ]
    )
...
def test_stats_calculates_rendered_text(_test_book, spanish):
    ...
    assert_stats(
        [
            '4; 3; 2; 67; {"0": 66.66666666666666, "1": 33.33333333333333, "2": 0.0, "3": 0.0, "4": 0.0, "5": 0.0, "98": 0.0, "99": 0.0}'
        ]
    )
...
def test_stats_only_update_books_marked_stale(_test_book, spanish):
    ...
    assert_stats(
        [
            '4; 4; 2; 50; {"0": 2, "1": 2, "2": 0.0, "3": 0.0, "4": 0.0, "5": 0.0, "98": 0.0, "99": 0.0}'
        ],
        "not updated",
    )
    ...
    assert_stats(
        [
            '4; 4; 1; 25; {"0": 1, "1": 3, "2": 0.0, "3": 0.0, "4": 0.0, "5": 0.0, "98": 0.0, "99": 0.0}'
        ],
        "updated",
    )
