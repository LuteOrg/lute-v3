...
INSERT INTO languages VALUES(13,'Modern Chinese','https://chinese.yabla.com/chinese-english-pinyin-dictionary.php?define=###','https://www.bing.com/images/search?q=###&form=HDRSC2&first=1&tsc=ImageHoverTitle','*https://www.deepl.com/translator#ch/en/###','´=''|`=''|’=''|‘=''|...=…|..=‥','.!?。！？','Mr.|Mrs.|Dr.|[A-Z].|Vd.|Vds.','一-龥',0,0,0,1,'modernchinese');
...
INSERT INTO books VALUES(14,13,'珍珠鸟','',0,22,600,NULL,NULL,NULL);
